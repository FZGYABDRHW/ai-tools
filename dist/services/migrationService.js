...
exports.rendererMigrationService = void 0;
class RendererMigrationService {
    ...
    async validateLocalStorageData() {
        const issues = [];
        let isValid = true;
        const dataSummary = {
            reports: 0,
...
exports.rendererMigrationService = new RendererMigrationService();
