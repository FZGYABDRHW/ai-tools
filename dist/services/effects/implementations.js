...
exports.ServicesLayer = exports.ReportGenerationServiceLive = exports.ReportLogServiceLive = exports.ReportCheckpointServiceLive = exports.ReportServiceLive = exports.FileSystemServiceLive = exports.LocalStorageServiceLive = exports.makeReportGenerationService = exports.makeReportLogService = exports.makeReportCheckpointService = exports.makeReportService = exports.LocalStorageServiceLayer = void 0;
...
// Service Layer
// ============================================================================
exports.LocalStorageServiceLayer = effect_1.Layer.succeed(types_1.LocalStorageService, makeLocalStorageService());
// ============================================================================
...
const makeReportService = () => ({
    ...
    saveReportData: (id, tableData, extractedParameters) => effect_1.Effect.try({
        ...
        catch: (error) => new types_1.StorageError(`Failed to save report data: ${error}`, 'write', id, error)
    }),
    clearReportData: (id) => effect_1.Effect.try({
        ...
        catch: (error) => new types_1.StorageError(`Failed to clear report data: ${error}`, 'write', id, error)
    })
});
...
exports.makeReportCheckpointService = makeReportCheckpointService;
// ============================================================================
...
exports.makeReportLogService = makeReportLogService;
// ============================================================================
...
const makeReportGenerationService = () => {
    ...
    return {
        ...
        startGeneration: (params) => effect_1.Effect.gen(function* () {
            ...
            let report = yield* (0, exports.makeReportService)().getReportById(params.reportId);
            if (!report) {
                report = yield* (0, exports.makeReportService)().createReport({
...
exports.makeReportGenerationService = makeReportGenerationService;
// ============================================================================
...
exports.ReportServiceLive = effect_1.Layer.succeed(types_1.ReportService, (0, exports.makeReportService)());
exports.ReportCheckpointServiceLive = effect_1.Layer.succeed(types_1.ReportCheckpointService, (0, exports.makeReportCheckpointService)());
exports.ReportLogServiceLive = effect_1.Layer.succeed(types_1.ReportLogService, (0, exports.makeReportLogService)());
exports.ReportGenerationServiceLive = effect_1.Layer.succeed(types_1.ReportGenerationService, (0, exports.makeReportGenerationService)());
