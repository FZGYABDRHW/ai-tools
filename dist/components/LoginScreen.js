...
const MultiCountryPhoneInput = ({ value, onChange, placeholder }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("style", { children: selectStyles }), (0, jsx_runtime_1.jsxs)("div", { style: {
                    display: 'flex',
                    alignItems: 'center',
                    ...
                    e.currentTarget.style.boxShadow = '0 1px 3px rgba(0, 0, 0, 0.05)';
                            ...
                            display: 'flex',
                            alignItems: 'center'
                        }, className: "country-select-no-border", dropdownStyle: {
                            zIndex: 9999,
                            borderRadius: '12px',
                            boxShadow: '0 8px 24px rgba(0, 0, 0, 0.12)',
                            border: '1px solid #e8e8e8',
                            padding: '8px 0'
                        }, suffixIcon: (0, jsx_runtime_1.jsx)("div", { style: {
                                fontSize: '12px',
                                color: '#666',
                                marginRight: '8px',
                                transition: 'transform 0.2s ease'
                            }, children: "\u25BC" }), optionLabelProp: "label", dropdownRender: (menu) => ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: {
                                        padding: '8px 16px',
                                        borderBottom: '1px solid #f0f0f0',
                                        fontSize: '12px',
                                        color: '#666',
                                        fontWeight: 500
                                    }, children: "Select Country" }), menu] })), children: countryOptions.map(country => ((0, jsx_runtime_1.jsx)(antd_1.Select.Option, { value: country.value, label: country.label, style: {
                                padding: '12px 16px',
                                fontSize: '14px',
                                borderRadius: '8px',
                                margin: '2px 8px',
                                transition: 'all 0.2s ease'
                                    ...
                                    gap: '12px'
                                        ...
                                        }, children: country.label.split(' ')[0] }), (0, jsx_runtime_1.jsxs)("div", { style: {
                                            display: 'flex',
                                            ...
                                            alignItems: 'flex-start'
                                                    ...
                                                    fontWeight: 500,
                                                    lineHeight: '1.2'
                                                }, children: country.label.split(' ').slice(1).join(' ') }), (0, jsx_runtime_1.jsx)("span", { style: {
                                                    color: '#666',
                                                    fontSize: '12px',
                                                    fontWeight: 400
                                                }, children: country.code })] })] }) }, country.value))) }), (0, jsx_runtime_1.jsx)(react_input_mask_1.default, { mask: countryMasks[selectedCountry], value: phoneNumber, onChange: handlePhoneChange, placeholder: placeholder, style: {
                            border: 'none',
                            outline: 'none',
                            flex: 1,
                            fontSize: '14px',
...
const LoginScreen = () => {
    const { login, isLoading, selectedServer } = (0, machines_1.useAuth)();
    ...
    return ((0, jsx_runtime_1.jsxs)(antd_1.Layout, { style: {
            ...
            transition: 'background 0.5s ease-in-out'
                    ...
                    `,
                            ...
                            transform: `scale(${animationDepth})`
                        } }), isLoading && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", { style: {
                                    position: 'absolute',
                                    top: '50%',
                                    left: '50%',
                                    width: '200px',
                            ...
                            `,
                                ...
                                } })] }))] }), (0, jsx_runtime_1.jsx)(Content, { style: {
                    display: 'flex',
                    ...
                    position: 'relative',
                    zIndex: 1
                }, children: (0, jsx_runtime_1.jsxs)(antd_1.Card, { style: {
                        maxWidth: 450,
                        width: '100%',
                        borderRadius: '12px',
                        ...
                        border: '1px solid rgba(255, 255, 255, 0.2)'
                    }, children: [(0, jsx_runtime_1.jsx)("div", { style: { textAlign: 'center', marginBottom: '32px' }, children: (0, jsx_runtime_1.jsx)("img", { src: logo_png_1.default, alt: "Wowworks Logo", style: {
                                    height: '120px',
                                    width: 'auto',
                                    marginBottom: '16px'
                                } }) }), (0, jsx_runtime_1.jsxs)(antd_1.Form, { form: form, onFinish: handleLogin, layout: "vertical", size: "large", children: [(0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "Server Region", style: { marginBottom: '20px' }, children: (0, jsx_runtime_1.jsx)(ServerSelector_1.default, {}) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { name: "phone", rules: [
                                    ...
                                    ], children: (0, jsx_runtime_1.jsx)(MultiCountryPhoneInput, { placeholder: "Phone number", onChange: (value) => form.setFieldsValue({ phone: value }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { name: "password", rules: [
                                        { required: true, message: 'Please enter your password' },
                                        { min: 6, message: 'Password must be at least 6 characters' }
                                    ], children: (0, jsx_runtime_1.jsx)(antd_1.Input.Password, { placeholder: "Password", prefix: (0, jsx_runtime_1.jsx)(icons_1.LockOutlined, { style: { color: '#bfbfbf' } }), style: { height: '48px', borderRadius: '8px' } }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { style: { marginBottom: '16px' }, children: (0, jsx_runtime_1.jsx)(antd_1.Button, { type: "primary", htmlType: "submit", loading: isLoading, style: {
                                            width: '100%',
                                            height: '48px',
                                            borderRadius: '8px',
                                            fontSize: '16px',
