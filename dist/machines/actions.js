...
exports.handleProfileLoadFailure = exports.handleTokenRefreshSuccess = exports.handleLogoutSuccess = exports.clearLoading = exports.setLoading = exports.updateServer = exports.clearError = exports.setError = exports.clearAuthData = exports.setUser = exports.setAuthData = exports.checkStoredAuth = void 0;
 ...
 */
exports.checkStoredAuth = (0, xstate_1.assign)({
 ...
 */
exports.setAuthData = (0, xstate_1.assign)({
    authToken: ({ context, event }) => {
 ...
 */
exports.setUser = (0, xstate_1.assign)({
    user: ({ context, event }) => {
 ...
 */
exports.clearAuthData = (0, xstate_1.assign)({
    authToken: () => {
 ...
 */
exports.clearError = (0, xstate_1.assign)({
    error: () => {
        console.log('AuthAction: Clearing error state');
        return null;
    }
 ...
 */
exports.updateServer = (0, xstate_1.assign)({
    selectedServer: ({ context, event }) => {
 ...
 */
exports.setLoading = (0, xstate_1.assign)({
 ...
 */
exports.clearLoading = (0, xstate_1.assign)({
    isLoading: () => {
 ...
 */
exports.handleLogoutSuccess = (0, xstate_1.assign)({
    authToken: () => {
 ...
 */
exports.handleTokenRefreshSuccess = (0, xstate_1.assign)({
    authToken: ({ context, event }) => {
 ...
 */
exports.handleProfileLoadFailure = (0, xstate_1.assign)({
    authToken: ({ context, event }) => {
