...
exports.refreshTokenActor = exports.logoutServiceActor = exports.loadUserProfileActor = exports.loginServiceActor = exports.initializeAuthActor = void 0;
 ...
 */
exports.initializeAuthActor = (0, xstate_1.fromPromise)(async () => {
    try {
 ...
 */
exports.loginServiceActor = (0, xstate_1.fromPromise)(async ({ input }) => {
 ...
 */
exports.loadUserProfileActor = (0, xstate_1.fromPromise)(async ({ input }) => {
    ...
    try {
        ...
        const si = (0, serviceInit_1.buildServiceInitializer)(token, server);
        ...
        if (response && response.id) {
            ...
            logRocketService_1.default.getInstance().identifyUser(response.id, {
                name: fullName,
                phone: response.phone || '',
 ...
 */
exports.logoutServiceActor = (0, xstate_1.fromPromise)(async ({ input }) => {
 ...
 */
exports.refreshTokenActor = (0, xstate_1.fromPromise)(async ({ input }) => {
